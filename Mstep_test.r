...
k = 6
#hyper.current
hypcurrent_file = "/mnt/YangFSS/data/jchen/20block_simulation/wkdir_1/hypval.current-5"
#Annotation file <- [SNPs,c(SNPname, gamma, beta, annotation1, annotation2, annotation3...)]
Annofile = "/mnt/YangFSS/data/jchen/20block_simulation/wkdir_1/Eoutput/AnnoScore5.txt"
print(hypcurrent_file)

wkDir = "/mnt/YangFSS/data/jchen/20block_simulation/wkdir_1/Eoutput"
########## Load beta and gamma 
